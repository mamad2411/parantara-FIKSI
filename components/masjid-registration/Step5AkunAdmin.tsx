      ...
      <div className="p-4 bg-gradient-to-r from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-xl">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm">
            <p className="font-bold text-blue-900 mb-2">🔐 Keamanan Akun:</p>
      ...
      <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-6 border-2 border-indigo-100">
        ...
        <div>
          ...
          <input
            ...
            required
          />
          <p className="text-xs text-gray-500 mt-2">Email ini akan digunakan untuk login ke dashboard admin</p>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 bg-white border-2 border-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all pr-12"
