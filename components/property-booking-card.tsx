  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        {features.length > 0 && (
          <div className="mb-4">
            <div className="mb-2 text-sm font-semibold text-slate-900">Detail Program</div>
        ...
        <div className="flex items-center justify-between mt-auto pt-4">
          <div>
            <div className="text-sm text-slate-500">Target Dana</div>
            <div className="text-2xl font-bold text-slate-900">
              {currency}
              {pricePerNight.toLocaleString('id-ID')}
            </div>
          </div>
          <button
            onClick={onBook}
